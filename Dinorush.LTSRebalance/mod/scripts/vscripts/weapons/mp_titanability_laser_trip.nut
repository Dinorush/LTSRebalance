...
const float LTSREBALANCE_LASER_TRIP_INNER_RADIUS = 225.0
const float LTSREBALANCE_LASER_TRIP_OUTER_RADIUS = 425.0
...
const float LTSREBALANCE_PAS_LASER_TRIP_DAMAGE_HEAVY_ARMOR = 1125.0
