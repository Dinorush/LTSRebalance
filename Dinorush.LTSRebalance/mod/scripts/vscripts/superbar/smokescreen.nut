/* LTS Rebalance replaces this file for the following reasons:
   1. Fix AI dodging away from friendly electric smoke
*/
...
void function SmokescreenAffectsEntitiesInArea( SmokescreenStruct smokescreen, SmokescreenFXStruct fxInfo )
{
	...
	AI_CreateDangerousArea_Static( aiDangerTarget, smokescreen.weaponOrProjectile, dangerousAreaRadius, aiDangerTarget.GetTeam(), true, true, fxInfo.center )
