...
{
	// Hijacking for Predator Cannon
	if ( LTSRebalance_Enabled() && weapon.GetWeaponClassName() == "mp_titanweapon_predator_cannon" )
		return OnWeaponChargeBegin_titanweapon_predator_cannon( weapon )
	return true
}
